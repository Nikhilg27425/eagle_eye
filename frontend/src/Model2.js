...
//           <h2>Live Camera Footage</h2>
//         </div>

//         {/* Replacing only the image section with video + canvas */}
//         <div className="video-container">
//           <video ref={videoRef} className="video-stream" controls />
...
//               </div>
//               <button className="button" onClick={startStreaming}>Start Detection</button>
...
//           <button onClick={handleUpload}>Upload and Start Streaming</button>
//           <p>{uploadStatus}</p>
//           {streaming && currentFrame && (
//             <div>
//               <h3>Processed Video Stream</h3>
//               <img src={currentFrame} alt="Processed Frame" style={{ width: "600px", border: "1px solid #000" }} />
//             </div>
//           )}
...
//       <h2>Upload Video for Real-Time Processing</h2>
//       <input type="file" accept="video/*" onChange={handleFileChange} />
//       <button onClick={handleUpload}>Upload and Start Streaming</button>
//       <p>{uploadStatus}</p>
//       {streaming && currentFrame && (
